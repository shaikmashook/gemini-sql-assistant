...
cursor.execute('''Insert Into Naresh_it_employee1 values('mashu','Data Engineer',65000)''')
cursor.execute('''Insert Into Naresh_it_employee1 values('javeed','ML Engineer',60000)''')
cursor.execute('''Insert Into Naresh_it_employee1 values('masood','Data Science',60000)''')
